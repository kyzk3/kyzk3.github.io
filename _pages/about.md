...
- [Hack The Box](https://app.hackthebox.com/profile/2450001) (+100 Machines)
- **Vulnhub** (+10 Machines)
- **DockerLabs** (+5 Machines)

## Certificados Académicos

### Hack4u

- [Introduccíon Linux](/assets/certs/Linux-cert.png)
- [Personalización de Linux](/assets/certs/Parrot-cert.png)
- [Introducción al Hacking](/assets/certs/Hacking-cert.png)
...
- Conocimiento de las vulnerabilidades del **OWASP Top 10**.  
- Manejo de entornos **Linux** para tareas administrativas y ofensivas.  
- Uso de herramientas de **hacking ético** (Nmap, Burp Suite, Metasploit, Wireshark, etc.).  
- Conocimientos básicos de **SIEM** y análisis de eventos de seguridad.  
- Redacción de **informes técnicos** claros y estructurados con **LaTeX**.  
- Scripting en **Python** y **Bash** para automatización de tareas.  
- Experiencia practicando en **laboratorios de ciberseguridad** y entornos controlados.  
- Familiaridad con metodologías de **pentesting** (reconocimiento, enumeración, explotación y postexplotación).  
- Gestión de entornos vulnerables, interconectando múltiples máquinas de **VulnHub** para practicar técnicas de pivoting y movimientos laterales.
